...
public class Dialogo {
    ...
    public static Label icone(String tipo) {
        ...
        switch (tipo) {
            case "INFO":
                label.getStyleClass().add("alerta-dialog");
                break;
            case "ERRO":
                label.getStyleClass().add("alerta-dialog-erro");
                break;
            case "ALERTA":
                label.getStyleClass().add("alerta-dialog-alert");
                break;
            case "CONFIRMAR":
                label.getStyleClass().add("alerta-dialog-confirmar");
                break;
            default:
                label.getStyleClass().add("alerta-dialog");
                break;
